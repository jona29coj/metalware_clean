interface InstantaneousControlProps {
...
const InstantaneousControl = ({ charge, setCharge, current, setCurrent, voltage, setVoltage, heatingStatus, toggleHeating }: InstantaneousControlProps) => (
